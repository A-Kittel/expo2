...
export default function SvgFb(){
    const fb = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const FbSvg = () => <SvgXml xml={fb} width="25%" height="25%" />;
